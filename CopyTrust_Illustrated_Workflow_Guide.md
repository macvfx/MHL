...
offline handoff, restore, hash re-verification, the pre-copy workflow
review with durable plan/log evidence, and proxy correctness.
...
Every delivered original is probed before proxy encoding. Display
